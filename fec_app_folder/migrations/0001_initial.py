# Generated by Django 4.0.7 on 2022-08-21 15:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student_number', models.CharField(blank=True, help_text='学籍番号', max_length=11, null=True, verbose_name='学籍番号')),
                ('room_number', models.CharField(help_text='教室名', max_length=4, verbose_name='教室名')),
        ...
        migrations.CreateModel(
            name='RoomDB',
            fields=[
                ('room_number', models.CharField(help_text='教室名', max_length=4, primary_key=True, serialize=False, verbose_name='教室名')),
                ('capacity', models.IntegerField(help_text='収容人数', verbose_name='収容人数')),
            ],
            options={
                'verbose_name': 'RoomDB',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('day_week', models.CharField(choices=[(1, '月曜日'), (2, '火曜日'), (3, '水曜日'), (4, '木曜日'), (5, '金曜日'), (6, '土曜日'), (7, '日曜日')], help_text='曜日', max_length=10, verbose_name='曜日')),
                ('room_number', models.CharField(help_text='教室名', max_length=4, verbose_name='教室名')),
                ('time', models.IntegerField(choices=[(1, '1限目'), (2, '2限目'), (3, '3限目'), (4, '4限目'), (5, '5限目'), (6, '6限目')], help_text='時間割', verbose_name='時間割')),
                ('capacity', models.IntegerField(help_text='収容人数', verbose_name='収容人数')),
                ('class_tf', models.BooleanField(default=False, help_text='利用ならTrue空きならFalse', verbose_name='利用状況')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.IntegerField(choices=[(1, '1限目'), (2, '2限目'), (3, '3限目'), (4, '4限目'), (5, '5限目'), (6, '6限目')], help_text='時間割', verbose_name='時間割')),
                ('capacity', models.IntegerField(help_text='収容人数', verbose_name='収容人数')),
                ('student_reserved', models.IntegerField(help_text='学生予約(学生予約でないなら0学生予約なら人数)', verbose_name='学生予約')),
